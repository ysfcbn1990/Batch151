...
ilkHarfEveyaColaniYaz(meyve);
        System.out.println();
        yildizEkleYaz(meyve);
        System.out.println();
        System.out.println(krkterSayisinaGoreBuyKucSiralaEnBuyukIlk3(meyve));

    }
    // SORU1 : List elemanlarının ilk harfi 'e' veya 'c' olanlari yazdıralım
    public static void ilkHarfEveyaColaniYaz(List<String> meyve ){
...
public static void yildizEkleYaz(List<String> meyve ){
    ...
    public static List<String> krkterSayisinaGoreBuyKucSiralaEnBuyukIlk3(List<String> meyve ){
       List<String>sonuc= meyve.
        ...
        return sonuc;
        //length ilk basta kizardi ama biz t.toString() koyarak oraya karakter sayisinin bos olmayacaginin teminatini vermis olduk
    }
