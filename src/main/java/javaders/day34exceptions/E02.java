...
String a[]={"A","V","A","J"};
    ...
    //Bir String array'den istenilen bir elemanı sırası ile alan method oluşturunuz
    public static String getElement(String a[],int numOfElement){
String result="";
      try{
         result= a[numOfElement-1];
      }catch (ArrayIndexOutOfBoundsException e){//ArrayIndexOutOfBoundsException array işlemlerinde olmayan index kullandığında atılır
